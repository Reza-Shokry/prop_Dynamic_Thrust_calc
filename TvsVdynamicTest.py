...
static_test_file_path ="dynamicTestData.csv"
...
d = 22
pitch = 15
Vmax = 45 #for draw a graph , Vmax is maximum Velocity in the graph
...
for i in range(0,6):
    ...
    plt.plot(V0Array, TArray,color=colors[i],label="RPM :"+str(motor_data["RPM"][i]))
    plt.scatter(motor_data['V'][i], motor_data["Thrust"][i], color=colors[i], s=10) #To convert grams to newtons ==> /1000*9.81
